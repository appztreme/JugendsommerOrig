(function (window) {
    ...
    window.__env.cities_jdul = ['Altrei', 'Aldein', 'Auer', 'Kurtatsch', 'Laag', 'Margreid', 'Montan', 'Neumarkt', 'Tramin', 'Truden', 'Salurn', 'Andere'];
    window.__env.tSizes = [
    ...
    window.__env.translations.de = {
        ...
        "RESERVATION": {
            ...
            "LABEL_REGISTRATION_PAY_INFO": "Mit erfolgreicher Anmeldung erhälst du ein Bestätigungsmail (kontrolliere auch den Spam-Ordner)",
            ...
            "LABEL_COVID_SWIM": "Zum jetzigen Zeitpunkt können wir noch nicht sagen ob die Hygienebestimmungen während des Sommers Schwimmtage zulassen. Diese Info fragen wir in der Zwischenzeit dennnoch ab, damit wir gegebenenfalls gleich startklar sind.",
