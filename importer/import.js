...
(async () => {
    ...
    for(let rec of records) {
        ...
        r.userId = rec.userId.toString();
        r.registrationDate = rec.registrationDate.toString();
        ...
        //r.gender = rec.gender;
        r.birthdayChild = rec.birthdayChild.toString();
        ...
        r.activityId = rec.activityId.toString();
