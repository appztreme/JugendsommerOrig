module.exports = {
    ...
    "cities": ['Afing',' Atzwang', 'Blumau', 'Deutschnofen', 'Durnholz', 'Eggen', 'Gossensass', 'Gummer', 'Jaufental', 'Jenesien', 'Karneid', 'Kastelruth', 'Marait', 'Mauls', 'Mölten', 'Neustift', 'Oberbozen', 'Penns', 'Pflersch', 'Petersberg', 'Ratschings', 'Reinswald', 'Ridnaun', 'Ritten', 'Sarnthein', 'Sarntal', 'Seis', 'Steinegg', 'Sterzing', 'Stilfes', 'Telfes', 'Tiers', 'Trens', 'Vöran', 'Weissenbach', 'Welschnofen', 'Wiesen', 'Andere'],
    "tSizes": [
