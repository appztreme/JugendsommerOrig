...
var eventSchema = db.Schema({
	...
	type: { type: String, enum: ['summer', 'music', 'spiritnight', 'club', 'jumprun', 'bike'], required: true, default: 'summer'},
	...
	siblingDiscount: { type: Number, required: true, default: 0 },
	optionalFeePerWeek: { type: Number, required: true, default: 0 },
